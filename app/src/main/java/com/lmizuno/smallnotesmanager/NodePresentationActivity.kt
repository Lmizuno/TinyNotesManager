...
class NodePresentationActivity : AppCompatActivity() {
    ...
    companion object {
        ...
        fun createIntent(context: Context, folderId: String?, presOption: PRESENTATION_OPTION = PRESENTATION_OPTION.SHALLOW): Intent {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val presOptionOrdinal = intent.getIntExtra(EXTRA_PRESENTATION_OPTION, PRESENTATION_OPTION.SHALLOW.ordinal)
    ...
    private fun loadNotesRecursively() {
        viewModel.loadNodesRecursively(currentFolderId) { allNodes ->
            ...
            if (notes.isNotEmpty()) {
                ...
                Toast.makeText(this, getString(R.string.no_notes_to_display), Toast.LENGTH_SHORT).show()
            }
        }
    }
}