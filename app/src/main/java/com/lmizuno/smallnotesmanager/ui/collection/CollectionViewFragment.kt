        ...
        binding.speedDialCollectionViewMenu.apply {
                ...
                SpeedDialActionItem.Builder(R.id.addItemButton, R.drawable.baseline_add_24_white)
                    .setFabBackgroundColor(
                        ResourcesCompat.getColor(
                            resources, R.color.primary, requireActivity().theme
                        )
                    ).setFabImageTintColor(
                        ResourcesCompat.getColor(
                            resources, R.color.white, requireActivity().theme
                        )
            ...
            addActionItem(
                SpeedDialActionItem.Builder(R.id.editCollection, R.drawable.baseline_edit_24)
                    .setFabBackgroundColor(
                        ResourcesCompat.getColor(
                            resources, R.color.yellow_pastel, requireActivity().theme
                        )
                    ).setFabImageTintColor(
                        ResourcesCompat.getColor(
                            resources, R.color.white, requireActivity().theme
            ...
            addActionItem(
                SpeedDialActionItem.Builder(
                    R.id.shareCollection, R.drawable.baseline_share_white_24
                ).setFabBackgroundColor(
                    ResourcesCompat.getColor(
                        resources, R.color.teal_200, requireActivity().theme
                    )
                ).setFabImageTintColor(
                    ResourcesCompat.getColor(
                        resources, R.color.white, requireActivity().theme
                    )
                ).setLabel("Share Collection").setLabelColor(Color.WHITE).setLabelBackgroundColor(
                        ResourcesCompat.getColor(
                            resources, R.color.primary, requireActivity().theme
                        )
                    ).create()
            ...
            addActionItem(
                SpeedDialActionItem.Builder(R.id.deleteCollection, R.drawable.recycle_bin_icon)
                    .setFabBackgroundColor(
                        ResourcesCompat.getColor(
                            resources, R.color.red, requireActivity().theme
                        )
                    ).setFabImageTintColor(
                        ResourcesCompat.getColor(
                            resources, R.color.white, requireActivity().theme
                ...
                when (actionItem.id) {
                    ...
                    R.id.editCollection -> {
                        ...
                        if (!editorToggle) {
                            addActionItem(
                                SpeedDialActionItem.Builder(
                                    R.id.editCollection, R.drawable.baseline_edit_off_24
                                ).setFabBackgroundColor(
                                    ResourcesCompat.getColor(
                                        resources, R.color.primary, requireActivity().theme
                                    )
                            ...
                            addActionItem(
                                SpeedDialActionItem.Builder(
                                    R.id.editCollection, R.drawable.baseline_edit_24
                                ).setFabBackgroundColor(
                                    ResourcesCompat.getColor(
                                        resources, R.color.yellow_pastel, requireActivity().theme
                                    )
